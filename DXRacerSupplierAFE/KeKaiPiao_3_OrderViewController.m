//
//  KeKaiPiao_3_OrderViewController.m
//  DXRacerSupplierAFE
//
...
@interface KeKaiPiao_3_OrderViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation KeKaiPiao_3_OrderViewController
...
- (void)viewDidLoad {
    ...
    [self setupButton];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(PIB:) name:@"PIB" object:nil];
}
- (void)PIB:(NSNotification *)text {
