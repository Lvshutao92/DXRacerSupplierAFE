//
//  OrderListDetailsTableViewController.m
//  DXRacerSupplierAFE
//
...
#import "OrderListDetails_7_Cell.h"
#import "Model1.h"
#import "Model2.h"
#import "Model.h"
#import "TimeZhou_Cell.h"
@interface OrderListDetailsTableViewController ()
{
    CGFloat height;
}
...
@implementation OrderListDetailsTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"订单详情";
    [self.tableView registerNib:[UINib nibWithNibName:@"OrderListDetails_7_Cell" bundle:nil] forCellReuseIdentifier:@"cell1"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        ...
        OrderListDetails_7_Cell *cell = [tableView dequeueReusableCellWithIdentifier:identifierCell];
        if (cell == nil) {
            cell = [[OrderListDetails_7_Cell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifierCell];
        }
        ...
        cell.lab4.text = [NSString stringWithFormat:@"入库库位：%@",model.location];
