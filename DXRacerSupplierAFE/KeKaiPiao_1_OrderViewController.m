//
//  KeKaiPiao_1_OrderViewController.m
//  DXRacerSupplierAFE
//
...
@interface KeKaiPiao_1_OrderViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation KeKaiPiao_1_OrderViewController
...
- (void)viewDidLoad {
    ...
    [self setupButton];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(PID:) name:@"PID" object:nil];
}


- (void)PID:(NSNotification *)text {
