//
//  KeKaiPiao_2_OrderViewController.m
//  DXRacerSupplierAFE
//
...
@interface KeKaiPiao_2_OrderViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation KeKaiPiao_2_OrderViewController
...
- (void)viewDidLoad {
    ...
    [self setupButton];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(PIC:) name:@"PIC" object:nil];
}


- (void)PIC:(NSNotification *)text {
