//
//  Order_6_3_TableViewController.m
//  DXRacerSupplierAFE
//
//  Created by ilovedxracer on 2017/10/20.
//  Copyright © 2017年 ilovedxracer. All rights reserved.
//

#import "Order_6_3_TableViewController.h"
#import "OrderListDetails_3_Cell.h"
#import "Order_6_Cell.h"
#import "Model1.h"
#import "Model2.h"
#import "Model.h"
#import "TimeZhou_Cell.h"
@interface Order_6_3_TableViewController ()
{
    CGFloat height;
}
...
@implementation Order_6_3_TableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"订单详情";
    [self.tableView registerNib:[UINib nibWithNibName:@"Order_6_Cell" bundle:nil] forCellReuseIdentifier:@"cell1"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        ...
        Order_6_Cell *cell = [tableView dequeueReusableCellWithIdentifier:identifierCell];
        if (cell == nil) {
            cell = [[Order_6_Cell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifierCell];
        }
        ...
        NSString *str = [NSString stringWithFormat:@"%lf",[model.quantity integerValue] * [model.price doubleValue]];
        
        NSMutableAttributedString *noteStr1 = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"采购总价：%@",[Manager jinegeshi:str]]];
...
//    cell.lab1.text = [NSString stringWithFormat:@"操作描述：%@",model.remark];
//    cell.lab2.text = [NSString stringWithFormat:@"操作时间：%@",[Manager TimeCuoToTime:model.createTime]];
//    cell.lab3.text = [NSString stringWithFormat:@"操作人：%@",model.operator];
